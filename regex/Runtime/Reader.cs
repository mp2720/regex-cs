...
namespace Regex.Runtime
{
    ...
    public abstract class Reader : IDisposable
    {
        ...
        // Saved here to prevent GC from collecting.
        private NativeAPI.Read nativeReadDelegate;
        private NativeAPI.Unwind nativeUnwindDelegate;

        /// <summary>
        /// WARNING: do not leak this structure to the context where the reader might be destroyed by GC,
        /// because this struct holds callbacks JIT-generated by .NET from delegates of this object.
        /// Freed by Dispose().
        /// </summary>
        ...
        {
            nativeReadDelegate = ReadNative;
            nativeUnwindDelegate = UnwindNative;
            ...
            unsafe
            {
                ...
                Native->read = Marshal.GetFunctionPointerForDelegate<NativeAPI.Read>(nativeReadDelegate);
                Native->unwind = Marshal.GetFunctionPointerForDelegate<NativeAPI.Unwind>(nativeUnwindDelegate);
