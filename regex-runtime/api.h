...
// // DEBUG: allocate printable string and make a text dump of the NFA.
// // Enormously huge NFAs (>= 2**32 states) are not supported.
// rcs_error rcs_debug_dump_nfa(const char **text_dump, struct rcs_nfa *nfa);

// // DEBUG: load text dump generated by `rcs_debug_dump_nfa`.
